...
public class ActivityRepositoryJdbc implements ActivityRepository {
    ...
    public ActivityRepositoryJdbc(DatabaseConnection db, RoutineRepository routineRepo) {
        this.db = db;
    ...
    private SelfCareActivityBase mapRow(ResultSet rs) throws SQLException {
        ...
        if ("WELLNESS".equalsIgnoreCase(type)) {
        ...
        throw new SQLException("Unknown activity_type: " + type);
    }
}
